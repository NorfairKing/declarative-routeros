# A lease for an address no server here hands out, so a lease that can never
# be given to anything.
/interface bridge
add name=lan
...
add address=10.0.0.10 mac-address=aa:aa:aa:aa:aa:aa server=dhcp1
